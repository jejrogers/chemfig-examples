...
\chemscheme{
    \schemestart
        ...
        \arrow(c2.base east--c2.base west){<=>[\cond{\Delta}][][8.4pt]}
        \chemleft[
            \chemfig{
                *6(
                    -
        ...
        \chemright]
        \arrow(c2.base east--c2.base west){->[\cond{\pm\ce{H+}}][][8.4pt]}
        \chemfig{
            *6(
                -
                =
...
\chemstruct{
    H_3C-[-1]S-[+1](-[-1]S-[+1,2]Sn?(<[+4,2]I)(<:[-2,2]I))=[+3]N-[+1]N?=[+3](-[+5]H_3C)-[+1]*6(=N?-(-[-1](-[+1]CH_3)=[-3]N?-[-1]N=[-3](-[-5]S?)-[-1]S-[+1]CH_3)=-=-)
}
